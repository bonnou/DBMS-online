...
@javax.annotation.Generated(value = { "Doma", "2.6.2" }, date = "2016-05-07T15:43:46.568+0900")
public class MusicResultDBHRDomaDaoImpl extends org.seasar.doma.internal.jdbc.dao.AbstractDao implements net.in.ahr.dbmsOnline.dao.MusicResultDBHRDomaDao {
    ...
    private static final java.lang.reflect.Method __method2 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(net.in.ahr.dbmsOnline.dao.MusicResultDBHRDomaDao.class, "getRankingByNameNha", net.in.ahr.dbms.data.network.request.dto.MusicResultDBHRDto.class);

    private static final java.lang.reflect.Method __method3 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(net.in.ahr.dbmsOnline.dao.MusicResultDBHRDomaDao.class, "insert", net.in.ahr.dbms.data.network.request.dto.MusicResultDBHRDto.class);

    private static final java.lang.reflect.Method __method4 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(net.in.ahr.dbmsOnline.dao.MusicResultDBHRDomaDao.class, "update", net.in.ahr.dbms.data.network.request.dto.MusicResultDBHRDto.class);
    ...
    @Override
    public java.util.List<net.in.ahr.dbms.data.network.request.dto.MusicResultDBHRDto> getRankingByNameNha(net.in.ahr.dbms.data.network.request.dto.MusicResultDBHRDto result) {
        entering("net.in.ahr.dbmsOnline.dao.MusicResultDBHRDomaDaoImpl", "getRankingByNameNha", result);
        try {
            if (result == null) {
                throw new org.seasar.doma.DomaNullPointerException("result");
            }
            ...
            __query.setConfig(__config);
            __query.setSqlFilePath("META-INF/net/in/ahr/dbmsOnline/dao/MusicResultDBHRDomaDao/getRankingByNameNha.sql");
            __query.setEntityType(net.in.ahr.dbms.data.network.request.dto._MusicResultDBHRDto.getSingletonInternal());
            __query.addParameter("result", net.in.ahr.dbms.data.network.request.dto.MusicResultDBHRDto.class, result);
            __query.setCallerClassName("net.in.ahr.dbmsOnline.dao.MusicResultDBHRDomaDaoImpl");
            __query.setCallerMethodName("getRankingByNameNha");
            __query.setResultEnsured(false);
            __query.setResultMappingEnsured(false);
            __query.setFetchType(org.seasar.doma.FetchType.LAZY);
            __query.setQueryTimeout(-1);
            ...
            __query.setSqlLogType(org.seasar.doma.jdbc.SqlLogType.FORMATTED);
            __query.prepare();
            org.seasar.doma.jdbc.command.SelectCommand<java.util.List<net.in.ahr.dbms.data.network.request.dto.MusicResultDBHRDto>> __command = getCommandImplementors().createSelectCommand(__method2, __query, new org.seasar.doma.internal.jdbc.command.EntityResultListHandler<net.in.ahr.dbms.data.network.request.dto.MusicResultDBHRDto>(net.in.ahr.dbms.data.network.request.dto._MusicResultDBHRDto.getSingletonInternal()));
            java.util.List<net.in.ahr.dbms.data.network.request.dto.MusicResultDBHRDto> __result = __command.execute();
            __query.complete();
            exiting("net.in.ahr.dbmsOnline.dao.MusicResultDBHRDomaDaoImpl", "getRankingByNameNha", __result);
            return __result;
        } catch (java.lang.RuntimeException __e) {
            throwing("net.in.ahr.dbmsOnline.dao.MusicResultDBHRDomaDaoImpl", "getRankingByNameNha", __e);
            throw __e;
        }
    }
    ...
    public int insert(net.in.ahr.dbms.data.network.request.dto.MusicResultDBHRDto musicResultDBHRDto) {
        ...
        try {
            ...
            org.seasar.doma.jdbc.query.AutoInsertQuery<net.in.ahr.dbms.data.network.request.dto.MusicResultDBHRDto> __query = getQueryImplementors().createAutoInsertQuery(__method3, net.in.ahr.dbms.data.network.request.dto._MusicResultDBHRDto.getSingletonInternal());
    ...
    public int update(net.in.ahr.dbms.data.network.request.dto.MusicResultDBHRDto musicResultDBHRDto) {
        ...
        try {
            ...
            org.seasar.doma.jdbc.query.AutoUpdateQuery<net.in.ahr.dbms.data.network.request.dto.MusicResultDBHRDto> __query = getQueryImplementors().createAutoUpdateQuery(__method4, net.in.ahr.dbms.data.network.request.dto._MusicResultDBHRDto.getSingletonInternal());
